  ...
  actions: {
    ...
    applyProfile(profile = {}) {
      ...
      const nextProfile = {
        ...
        attendance_seat_map_columns: hasProfileKey("attendance_seat_map_columns") ? Number(profile.attendance_seat_map_columns) || 4 : Number(this.profile.attendance_seat_map_columns) || 4,
        ...
        attendance_teacher_module_enabled: hasProfileKey("attendance_teacher_module_enabled") ? profile.attendance_teacher_module_enabled !== false : this.profile.attendance_teacher_module_enabled !== false,
      ...
      updateStoredUser({
        ...
        attendance_seat_map_columns: nextProfile.attendance_seat_map_columns,
        ...
        attendance_teacher_module_enabled: nextProfile.attendance_teacher_module_enabled,
