        ...
        <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p class="mt-2 max-w-3xl text-sm leading-6 text-slate-500 dark:text-slate-400">
              Atur modul yang tampil di sekolah. Modul dasar tetap aktif, sementara Sarpras dan Ujian Resmi bisa
              diaktifkan atau dimatikan per sekolah.
            </p>
          </div>
          ...
          <table class="min-w-full text-left text-sm">
            ...
            <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
              ...
              <tr v-if="schools.length === 0">
                <td colspan="4" class="px-4 py-10 text-center text-slate-500 sm:px-6">Belum ada sekolah terdaftar.</td>
              </tr>
            </tbody>
          </table>
        </div>
